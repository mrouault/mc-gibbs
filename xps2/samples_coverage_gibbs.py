...
for k in range(100) :
    ...
    sample_gibbs = target.sample(key_gibbs_mala, start_sample_gibbs_reshaped, n_iter = n_iter_gibbs, step_size = step_size_gibbs, method = 'mala', stable = False)
...
pickle.dump(dic_gibbs, open("gibbs_mala_"+s+".p", "wb"))